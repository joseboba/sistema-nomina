...
export const employeeSlice = createSlice({
    ...
    reducers: {
        ...
        setEmployee: (state, {payload}: PayloadAction<EmployeeInterface>) => {
            ...
            state.empFechaNacimiento = moment( payload.empFechaNacimiento,"DD-MMM-YY hh.mm.ss.SSSSSSSSS A");
            ...
            state.empFechaInicio = moment( payload.empFechaInicio,"DD-MMM-YY hh.mm.ss.SSSSSSSSS A");
            ...
            state.epuFechaInicio = moment( payload.epuFechaInicio,"DD-MMM-YY hh.mm.ss.SSSSSSSSS A");
            state.epuFechaFinal = moment( payload.epuFechaFinal,"DD-MMM-YY hh.mm.ss.SSSSSSSSS A");
